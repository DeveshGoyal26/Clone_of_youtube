...
logo.addEventListener("click", () => {
   window.location.href = "index.html";
     ...
     let mp = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=IN&key=AIzaSyBI3XXCba3v0xkHuyKgeOJMhJvztZKMw_E&maxResults=60`
     ...
     mostPopular()
        ...
        let search_data = async () => {
            ...
            let search_url = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=${search}&type=video&key=AIzaSyBMt0siSYEHL-VFTTpdWmXzUyN23oj_Eqs&maxResults=10`
